...
/*!
 * The index of the first completed item within the list's items. \c nil if there is no complete list item in
 * the presented list items.
 */
@property (readonly) NSInteger indexOfFirstCompletedListItem;
