...
- (UIImage *)groupBackgroundImage {
    ...
    [self drawCompletedItemsCountInCurrentContext];
...
- (void)drawCompletedItemsCountInCurrentContext {
    ...
    CGSize completeSize = [itemsCompletedText sizeWithAttributes:completeAttributes];
    ...
    [itemsCompletedText drawInRect:CGRectIntegral(completeRect) withAttributes:completeAttributes];
